...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'boerum.heading': 'PODERE MONTALE,\nSEGGIANO, TUSCANY',
    'boerum.description': 'We chose this place because it\'s a little casolare in the nature because we think it represents us and what we strive for: here we can be intimate in the nature and appreciate good food and genuine connections.',
    'boerum.location.description': 'To give you an idea of the travel times by car, you\'ll find them listed below. It might be a bit of a drive, but having you there means the world to us',
  ...
  it: {
    ...
    'boerum.sunday.event': 'Check-out',
    'boerum.heading': 'PODERE MONTALE,\nSEGGIANO, TOSCANA',
    'boerum.description': 'Abbiamo scelto questo posto perché è un piccolo casolare nella natura perché pensiamo che rappresenti noi e ciò a cui aspiriamo: qui possiamo essere intimi nella natura e apprezzare il buon cibo e le connessioni genuine.',
    'boerum.location.description': 'Per darvi un\'idea dei tempi di viaggio in auto, li troverete elencati qui sotto. Potrebbe essere un po\' di strada, ma avervi lì significa il mondo per noi',
